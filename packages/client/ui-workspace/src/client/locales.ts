...
export const zh = {
  ...
  'menu.trashSession': '移入回收站',
  'trash.title': '回收站',
  'trash.restore': '恢复',
  'trash.empty': '清空回收站',
  'trash.empty.desc': '将永久删除回收站中的所有会话记录、缓存和文件，此操作不可撤销。',
  'trash.empty.confirm': '确认清空',
  'trash.empty.cancel': '取消',
  'trash.count': '{n} 个已删除会话',
  'trash.restore.aria': '恢复会话"{name}"',
  'trash.session.aria': '已删除会话"{name}"',
...
export const en = {
  ...
  'menu.trashSession': 'Move to trash',
  'trash.title': 'Trash',
  'trash.restore': 'Restore',
  'trash.empty': 'Empty trash',
  'trash.empty.desc': 'Permanently delete all session logs, cache, and files in trash. This cannot be undone.',
  'trash.empty.confirm': 'Confirm empty',
  'trash.empty.cancel': 'Cancel',
  'trash.count': '{n} deleted sessions',
  'trash.restore.aria': 'Restore session "{name}"',
  'trash.session.aria': 'Deleted session "{name}"',
